...
<div class="container col-md-12  text-center" id="inicio-user">	
	<div id="container_principal">
		<div class="col-md-12" id="header_encuesta">
			<h3 class="titulo_menu"><span class="fa fa-user-plus"></span> Confirmar Actas</h3>	
		</div>
		...
		<div class="col-md-12 centrar">
			<div class="col-md-11 table-responsive">
				<table class="table table-bordered table-condensed table-hover table-responsive" id="tabla_actas_personas"  cellspacing="0" width="100%">
				<thead>
					<tr>
						<th class="nombre_tabla" colspan="4">Personas</th>
					</tr>
...
<script>
    $(document).ready(function () {
		inactivityTime();
		listar_actas_personas(<?php echo ($id) ?>);
	});
</script>
