  ...
  <table class="table table-bordered">
    <thead>
      <tr>
        ...
        <td>
        <?php echo $version?> <br> <?php echo $fecha?> <hr> <?php echo $trd?> <hr> #Participantes : <?php echo count($datos)?>
        </td>
      </tr>
      <tr>
      ...
      <?php
        foreach($datos as $row) {
          ...
          echo "<td>Programa</td>";
          echo "<td>Temática</td>";
          echo "<td>De las siguientes actividades de Bienestar Estudiantil marque con una X en la que usted participó.</td>";
          echo "<td>¿Cómo le pareció la actividad desarrollada?</td>";
          echo "<td>La atención del servicio que usted recibió fue:</td>";
          echo "<td>Los temas tratados, ¿le resultan apropiados para ayudarle en su desempeño?   </td>";
          echo "<td>¿Consideras que el tema abordado aporta a tu formación integral?</td>";
          echo "<td>¿Cómo le pareció la metodología utilizada por la persona que dirigió la actividad?</td>";
          echo "<td>¿Qué otros cursos o talleres le gustaría que implementara la Vicerrectoría de Bienestar Universitario?</td>";
